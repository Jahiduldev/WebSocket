        <footer class="footer-area section-gap">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-sm-6">
                            <div class="single-footer-widget">
                                <h6>About Us</h6>
                                <p>
                                    Mosharraf Spinning Mills Limited is a 100% export oriented yarn manufacturing company.
                                </p>
                                <p class="footer-text">
                                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Design & Developed<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://2aitbd.com" target="_blank">2A IT</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                </p>                                
                            </div>
                        </div>
            ...
            <script src="<?=base_url();?>assets/frontend/js/hexagons.min.js"></script>                          
