    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                    <?=form_open_multipart("about/course", array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                           ...
                                           <label class="col-md-3 control-label">Category</label>
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" name="course_cat" id="course_cat"  required> 
                                                    ...
                                                    <option value="1">Our Mission</option>
                                                    <option value="2">Our Vission</option>
                                                    <option value="3">Our Objective</option>
