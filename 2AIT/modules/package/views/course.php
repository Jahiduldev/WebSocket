    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                    <?=form_open_multipart("package/course", array('class' => 'form-horizontal'))?>
                            <div class="form-body">
