                            ...
                            <?=form_open_multipart("gallery/add", array('class' => 'form-horizontal'))?>
                                    <div class="form-body">
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php  
                                                    $gal_cats = $this->CoreZ_IT->get('gallery_cat')->result(); ?>
                                                    <select class="form-control" name="gallery_cat" id="gallery_cat"  required> 
                                                        <option value="7">Select category</option>
                                                        <?php foreach($gal_cats as $gal_cat ){ ?>
                                                            <option value="<?=$gal_cat->id?>"><?=$gal_cat->title?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                                            <img src="assets/frontend/images/restaurant.jpeg" alt=""/>
                                                        </div>
